  ...
  return (
    <div className="flex w-full h-full ">
      <div className="flex flex-col gap-6 w-full h-full p-12 ml-32 mt-12 ">
        <h2 className="text-3xl font-bold">Create a Template</h2>
        ...
        <div className="flex gap-4 items-center">
          ...
          <input
            ...
            className=" border border-gray-300
                        ...
                        "
          />
          <FaPlus className="text-2xl border border-gray-300 rounded-lg p-1 shadow-lg cursor-pointer hover:bg-gray-200" />
        </div>
        ...
        {/* Comments */}
        <div className="flex gap-4 items-center">
          <h4 className="w-1/6 text-gray-700 ">Comments</h4>
          <textarea
            rows="4"
            cols="64"
            className=" border border-gray-300 mt-4
